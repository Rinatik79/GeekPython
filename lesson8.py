...
warehouse.add_printers_to_warehouse("22")
warehouse.add_scanners_to_warehouse("33")
warehouse.add_copiers_to_warehouse(44)
warehouse.add_copiers_to_warehouse("MNOGO!!!")
print(warehouse.current_warehouse_state)
warehouse.send_scanners_to_division(77, "IT")
...
warehouse.send_copiers_to_division("100", "bookkeeping")
warehouse.send_printers_to_division("8", "bookkeeping")
warehouse.send_scanners_to_division(3, "bookkeeping")
warehouse.send_copiers_to_division(10, "bookkeeping")
print(warehouse.current_division_state)
print(warehouse.current_warehouse_state)
warehouse.send_copiers_to_division("MNOGO!!!", "bookkeeping")
print(warehouse.current_division_state)
print(warehouse.current_warehouse_state)
...
class ComplexNumber:
    ...
    def __add__(self, other):
        ...
        new_complex_part = self.complex_part + other.complex_part
        return str(new_real_part) + " + " + str(new_complex_part) + "i"

    def __mul__(self, other):
        new_real_part = (self.real_part * other.real_part) - (self.complex_part * other.complex_part)
        new_complex_part = (self.real_part * other.complex_part) + (self.complex_part * other.real_part)
        return str(new_real_part) + " + " + str(new_complex_part) + "i"

    def __str__(self):
        return str(self.real_part) + " + " + str(self.complex_part) + "i"


x = ComplexNumber("5.2 + 3.3i")
y = ComplexNumber("1.1 + 1.3i")
print(ComplexNumber(x + y))
print(ComplexNumber(x * y))
